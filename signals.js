...
const SIGNALS = {
  ...
  expand: {
    label: 'Expanding abroad',
    clientId: '44911081-1633-4008-bb8b-fb79f9e0f5ad', // TEST UK Companies Expanding Abroad
    freshDays: 365,
    intelNoun: 'international expansion announcement (opening abroad / going global)',
    loaderMoment: 'UK companies expanding abroad',
    needLead: "they're expanding into a new country and need",
    signalRow: () => ['Signal', 'Expanding abroad'],
    ...
    services: {
      legal: { label: 'Commercial legal', audience: 'commercial and international solicitors',
        needTail: 'a foreign entity and contracts set up',
        senderDesc: 'a commercial law firm that helps UK companies set up entities, contracts and compliance when they expand abroad',
        emailRefAsk: 'reference their SPECIFIC company and expansion; offer legal help to set up the foreign entity, contracts and compliance' },
      recruitment: { label: 'Recruitment', audience: 'international recruiters',
        needTail: 'a local team in the new market',
        senderDesc: 'a recruitment business that helps UK companies hire a local team when they expand into a new country',
      ...
      marketing: { label: 'International marketing', audience: 'marketing agencies with international reach',
        ...
        senderDesc: 'a marketing agency that helps UK companies launch and localise their marketing in a new international market',
